                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          await MessageController.I.createNewThread(newThread);

                          GlobalRouter.I.router
                              .go("${ChatScreen.route}/${newThread.threadId}");
                        },
                        child: Container(
                          height: 254,
                          width: 190,
                      ...
                      Column(
                        ...
                        children: [
                          InkWell(
                            onTap: () {
                              GlobalRouter.I.router.go(SaveThreadScreen.route);
                            },
                            child: Container(
                ...
                SizedBox(
                    ...
                    child: StreamBuilder(
                        stream: MessageController.I
                            .getUserThreads(AuthController.I.currentUser!.uid),
                        builder: (context, snapshot) {
